...
我像河南省学生资助管理中心进行了电话咨询，对方表示这个数据要去国家开发银行河南分行咨询。国家开发银行河南分行负责助学贷款的经理表示要想获得这个数据需要公对公的进行，在一番解释之后她表示可以向领导申请获得这一数据。之后也没了下文。不过经理同意了接受简短的采访。她回答了河南省助学贷款的整体概况，催还款的细节，同时表示一些数据可以在教育厅查查看。采访结束，我在河南省教育厅查找了相关内容，发现关于国家助学贷款违约率每年是有一个相关公告的，只是这一数据不够系统。不过整理后发现，也正符合经理所说的整体下降趋势。
...
政策呈现上，用时间轴呈现是较为清晰明确的，可以让读者一目了然。数据的呈现秉着最能呈现数据趋势的原则，选取了不同的呈现方式。基本按照读者的阅读逻辑来进行了图表的设计，同时选取一些相关的矢量图，让图更加的生动。如选择“钱袋子”来代表钱等。至于哪些数据进行可视化，主要选择了一些数据庞大、比较系统，只要呈现相关趋势的数据进行了可视化。通过图文，帮助读者更好的理解想要表达的内容。
